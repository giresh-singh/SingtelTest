...
public class HomePage {
    ...
    public void applyCompletedFilter() {
        try {
            selHelper.click(HomePageOR.TO_DO_FILTER_Completed);
            String strStatus = selHelper.getAttribute(HomePageOR.TO_DO_FILTER_Completed);
    ...
    public void applyActiveFilter() {
        try {
            selHelper.click(HomePageOR.TO_DO_FILTER_Active);
            String strStatus = selHelper.getAttribute(HomePageOR.TO_DO_FILTER_Active);
            if (strStatus.contains("selected")) {
    ...
    public void applyAllFilter() {
        try {
            selHelper.click(HomePageOR.TO_DO_FILTER_All);
            String strStatus = selHelper.findElement(HomePageOR.TO_DO_FILTER_All).getAttribute("class");
            if (strStatus.contains("selected")) {
